...
@section('content')
<div id="titulo-admin">
    <div id="migajas-titulo"><i class="icon-creative-commons-share"> </i> CATEGORIAS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; {{$categoria->nombre_categoria}} </div>
...
<div id="elemento-admin">
    <div id="texto-titulo"> <i class="icon-list"> </i> {{$categoria->nombre_categoria}} </div>
