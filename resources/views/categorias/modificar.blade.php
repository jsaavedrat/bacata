...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-share"> </i> CATEGORÍAS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; EDITAR</div>
...
<div id="elemento-admin">
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> Editar categoría</div>

    <form method="post" data-parsley-validate action="{{ route('categorias.modificar') }}">
        @csrf
        <div class="label-campo">
            ...
            <input type="text" name="nombre_categoria" class="campo-admin" placeholder="Nombre" spellcheck="false" autocomplete="off" maxlength="25" id="nombre_categoria" onkeyup="this.value=letras(this.value)" value="{{$categoria->nombre_categoria}}">
        </div>

        <input type="number" name="id_categoria" value="{{$categoria->id_categoria}}" style="display: none;">

        <button class="boton-admin"> Editar Categoría</button>
    </form>
</div>
