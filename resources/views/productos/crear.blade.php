...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> Ingresar Productos</div>

    <form method="post" id="formulario" data-parsley-validate action="{{ route('productos.guardar') }}">
        @csrf

        <div class="content-bodega-sucursal">
            <div id="error-bodega" onclick="this.style.display='none'">Seleccione Bodega de Ingreso</div>
            <div id="error-proveedor" onclick="this.style.display='none'">Seleccione El Proveedor</div>
            <div class="label-campo label-ingreso">
                <div class="label-admin" id="label_marca"><i id="lista" class="icon-dot-single"></i>Bodega de Ingreso:<i id="cont-icon" class="icon-location"></i></div>
                <select class="campo-admin" name="bodega" id="bodega" required>
        ...
        <div id="modal-confirmar">
            <div id="content-modal-confirmar">
                ...
                <div id="establecimiento-entrada">
                    Ingresando Productos a Bodega: Principal Conj Sauces
                </div>
