...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="fa fa-users"> </i> USUARIOS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; EDITAR</div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="icon-pencil"> </i> Editar Usuario</div>

    <form method="post" action="{{ route('empleados.modificar') }}">
        @csrf
            <div class="label-campo">
                ...
                <input type="text" name="nombre_empleado" id="nombre_empleado" class="campo-admin" placeholder="Nombre del empleado" spellcheck="false" autocomplete="off" maxlength="35" required onkeyup="this.value=letras(this.value)" value="{{$empleado->name}}">
            </div>
            <div class="label-campo">
                ...
                <input type="text" name="apellido_empleado" id="apellido_empleado" class="campo-admin" placeholder="Apellido del empleado" spellcheck="false" autocomplete="off" maxlength="35" required onkeyup="this.value=letras(this.value)" value="{{$empleado->apellido}}">
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="text" name="telefono_empleado" id="telefono_empleado"class="campo-admin" placeholder="Teléfono del empleado" spellcheck="false" autocomplete="off" maxlength="20" required onkeyup="this.value=telefono(this.value)" value="{{$empleado->telefono}}">
            </div>
            ...
            <div class="label-campo">
                ...
                <select class="campo-admin" name="tipo_identificacion_empleado" id="tipo_identificacion_empleado" required>
                    <option value="{{$empleado->id_tipo_identificacion}}">{{$empleado->nombre_tipo_identificacion}}</option>
                    @foreach($tipos_identificacion as $tipo_identificacion)
                        @if($tipo_identificacion->id_tipo_identificacion != $empleado->id_tipo_identificacion)
            ...
            <div class="label-campo">
                ...
                <input type="text" name="identificacion_empleado" id="identificacion_empleado" class="campo-admin" placeholder="N° de identificación" spellcheck="false" autocomplete="off" maxlength="25" required onkeyup="this.value=identificacion(this.value)" value="{{$empleado->identificacion}}">
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="text" name="correo_empleado" id="correo_empleado" class="campo-admin" placeholder="Correo empleado" spellcheck="false" autocomplete="off" maxlength="35" required value="{{$empleado->email}}">
            </div>
            ...
            <div class="label-campo" style="width: 66.6%;">
                ...
                <textarea name="direccion_empleado" id="direccion_empleado" class="campo-admin" placeholder="Dirección empleado" spellcheck="false" autocomplete="off" maxlength="120" style="margin-bottom:-5px!important;" onkeyup="this.value=direccion(this.value)">{{$empleado->direccion}}</textarea>
            </div>


            <input type="hidden" name="id_empleado" value="{{$empleado->id}}">
            
        <button class="boton-admin" id="crear-empleado"> Editar Empleado</button>
...
<script type="text/javascript">
    ...
    $("#crear-empleado").click(function(){
        ...
        for(i = 0; i < listaSucursales.length; i++){
            if(listaSucursales[i].estado == "inactivo"){
                cont = cont + 1;
            }
        }
        ...
        if (listaSucursales.length==cont){
