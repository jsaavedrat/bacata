...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-arrow-with-circle-down"> </i> INGRESOS &nbsp;<i class="fa fa-angle-right"> </i> BODEGAS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; EXCEL &nbsp;<i class="fa fa-angle-right"> </i> CARGAR</div>
    <div id="content-imagen-titulo"><img style="height:100%;float: right;" id="imagen-principal"></div>
</div>

<div id="iconos-titulo">
    <div class="icono-titulo"><a href="{{ route('home') }}">         <i class="fa fa-home herramientas"></i><div class="content-texto"><p class="texto-icono">INICIO</p></div></a></div>
    <div class="icono-titulo"><a href="{{ route('ingresos.excel.crear') }}"><i class="icon-list herramientas"> </i><div class="content-texto"><p class="texto-icono">CARGAR EXCEL</p></div></a></div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> Cargar Excel para Ingreso Masivo a BODEGA</div>
    <form method="post" id="formulario" data-parsley-validate  action="{{ route('ingresos.excel.guardar') }}" enctype="multipart/form-data">
        @csrf

        <div class="label-campo">
            <div id="error-bodega" class="errores" onclick="this.style.display='none'">Seleccione Bodega de Ingreso</div>
            <div class="label-admin"><i id="lista" class="icon-dot-single"></i>Bodega a ingresar productos:<i id="cont-icon" class="fa fa-home"></i></div>
            <select class="campo-admin" name="id_bodega" id="id_bodega" required>
