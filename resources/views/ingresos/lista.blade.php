...
<div id="elemento-admin">
    <div id="texto-titulo"> <i class="icon-arrow-with-circle-down"> </i> Lista de Ingresos a Sucursal</div>
        ...
        <tbody>
            ...
            @foreach($ingresos as $ingreso)
                <tr>
                    ...
                    <td>{{$ingreso->nombre_bodega}}</td>
                    <td>{{$ingreso->cantidad}}</td>
                    <td class="td-acciones">
                        <div class="iconos-acciones">
                            <div class="content-acciones">
                                <a class="dropdown-content"><i class="icon-forward"> </i> VER</a>
                                <i onclick="ver('{{$ingreso->id_ingreso}}');" class="icon-forward i-acciones"> </i> &nbsp;
                            </div>
                        </div>
                    </td>
                </tr> 
    ...
    $(document).ready( function () {
        $('#tabla').DataTable( {
            ...
            buttons: [
                {
                    extend: 'excel',
                    filename: 'Bodegas Optica Angeles',
                    title: '',
                    header: false
                },
                {
            ...
            language: {
                ...
                info:           "Mostrando bodegas del _START_ al _END_ de un total de _TOTAL_ bodegas",
                infoEmpty:      "Mostrando bodegas del 0 al 0 de un total de 0 bodegas",
