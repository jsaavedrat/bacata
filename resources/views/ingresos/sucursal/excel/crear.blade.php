...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-arrow-with-circle-down"> </i> INGRESOS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; SUCURSAL &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; EXCEL &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; GENEREAR</div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-file-excel-o"> </i> Crear Formato Excel Para Ingreso a Sucursal</div>
