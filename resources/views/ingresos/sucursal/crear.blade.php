...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="fa fa-tags"> </i> PRODUCTOS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; INGRESAR</div>
    <div id="content-imagen-titulo"><img style="height:100%;float: right;" id="imagen-principal"></div>
</div>

<div id="iconos-titulo">
    <div class="icono-titulo"><a href="{{ route('home') }}">         <i class="fa fa-home herramientas"></i><div class="content-texto"><p class="texto-icono">INICIO</p></div></a></div>
    <div class="icono-titulo"><a href="{{ route('productos.lista') }}"><i class="icon-list herramientas"> </i><div class="content-texto"><p class="texto-icono">LISTA DE PRODUCTOS</p></div></a></div>
...
<div id="elemento-admin">
    <div id="content-mensaje">
        @if($estatus=="exito")<div id="mensaje-exito"> <i class="fa fa-check-circle"></i> Productos Ingresados Exitosamente</div>@endif
        @if($estatus=="error")<div id="mensaje-error"> <i class="fa fa-times-circle"></i>&nbsp; ERROR PRODUCTOS</div>@endif
    </div>

    <div id="texto-titulo"> <i class="fa fa-plus"> </i> Ingreso a Sucursal</div>

    <form method="post" id="formulario" data-parsley-validate action="{{ route('ingresos.sucursal.guardar') }}">
        @csrf

        <div class="content-sucursal">
            <div id="error-sucursal" onclick="this.style.display='none'">Seleccione Sucursal de Ingreso</div>
            <div class="label-campo label-ingreso">
                <div class="label-admin" id="label_marca"><i id="lista" class="icon-dot-single"></i>Sucursal de Ingreso:<i id="cont-icon" class="icon-location"></i></div>
                <select class="campo-admin" name="sucursal" id="sucursal" required>
        ...
        <div id="modal-confirmar">
            <div id="content-modal-confirmar">
                ...
                <div id="establecimiento-entrada">
                    Ingresando Productos a Sucursal: Nombre Sucursal
                </div>
                <div id="informacion-cantidades">
                    Productos diferentes: Cantidad de productos
                </div>
...
<script type="text/javascript">
    ...
    function agregar(numero){
        ...
        crear = `
            ...
            <div class="eliminar" onclick="eliminarProducto('informacion-producto-`+numero+`')"><i class="icon-cross"></i></div>
            ...
            <div class="label-campo label-campo-valores">
                <label class="label-admin"><i id="lista" class="icon-dot-single"></i>Precio Venta</label>
            ...
            {{--<div class="label-campo label-campo-valores">
                ...
                <div class="content-imagenes"></div>
            </div>--}}
    ...
    function confirmar(){
        ...
        for (i = 0; i < n.length; i++) {
            ...
            if(codigo=="" || cantidad=="" || precio_producto==""){
                document.getElementById("borde-error-"+x).style.border="1px solid rgba(200,50,50,1)";
                valid = false;
            }
        ...
        if (sucursal=="" || sucursal==null) {
            valid=false;
            document.getElementById("error-sucursal").style.display="block";
        }else{
            document.getElementById("error-sucursal").style.display="none";
        }
