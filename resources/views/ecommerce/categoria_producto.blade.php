			...
			<div class="row">
				...
				<div class=" col-12 col-sm-12 col-md-4">
					...
					<div class="site-pagination">
						...
						<a href="{{route('ecommerce.categoria',$nombre_tipo_producto->id_tipo_producto)}}">{{$nombre_tipo_producto->nombre_tipo_producto}} /</a>
						<a>{{$nombre_especificacion->nombre_especificacion}}</a>
					</div>
				</div>
