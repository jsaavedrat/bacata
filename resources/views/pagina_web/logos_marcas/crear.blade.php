...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-attribution"> </i> LOGOS MARCAS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; AGREGAR</div>
    <div id="content-imagen-titulo"><img style="height:100%;float: right;" id="imagen-principal"></div>
</div>

<div id="iconos-titulo">
    <div class="icono-titulo"><a href="{{ route('home') }}">         <i class="fa fa-home herramientas"></i><div class="content-texto"><p class="texto-icono">INICIO</p></div></a></div>
    <div class="icono-titulo"><a href="{{ route('pagina.logos_marcas.lista') }}"><i class="icon-list herramientas"> </i><div class="content-texto"><p class="texto-icono">LISTA DE LOGOS MARCAS</p></div></a></div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> AGREGAR LOGO MARCA EN PÁGINA WEB</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.logos_marcas.guardar') }}" enctype="multipart/form-data">
        @csrf
        <div style="width: 100%;float: left;">
            <div class="label-campo">
                ...
                <input type="text" name="nombre_marca" id="nombre_marca" class="campo-admin" placeholder="Nombre de la marca" spellcheck="false" autocomplete="off" maxlength="50" required>
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="file" class="campo-admin" name="imagen_logo_marca" id="imagen_logo_marca" required>
            </div>
        </div>

        <button class="boton-admin" id="crear-logo-marca"> Agregar logo marca</button>
    </form>
</div>
