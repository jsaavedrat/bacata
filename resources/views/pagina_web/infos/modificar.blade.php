...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-attribution"> </i> INFOS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; EDITAR</div>
    <div id="content-imagen-titulo"><img style="height:100%;float: right;" id="imagen-principal"></div>
</div>

<div id="iconos-titulo">
    <div class="icono-titulo"><a href="{{ route('home') }}">         <i class="fa fa-home herramientas"></i><div class="content-texto"><p class="texto-icono">INICIO</p></div></a></div>
    <div class="icono-titulo"><a href="{{ route('pagina.infos.lista') }}"><i class="icon-list herramientas"> </i><div class="content-texto"><p class="texto-icono">LISTA DE SERVICIOS</p></div></a></div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-pencil"> </i> MODIFICAR INFO EN PÁGINA WEB</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.infos.modificar') }}" enctype="multipart/form-data">
        @csrf
        <div style="width: 100%;float: left;">
            <div class="label-campo">
                ...
                <input type="text" name="nombre_info" id="nombre_info" class="campo-admin" placeholder="Nombre de la info" spellcheck="false" autocomplete="off" maxlength="50" required value="{{$info->nombre_info}}">
            </div>
            <div class="label-campo">
                <div id="error-detalle-info" onclick="this.style.display='none'"> <i class="fa fa-times-circle"></i>&nbsp; Ingrese Detalle Info</div>
                <label class="label-admin" for="detalle-info"><i id="lista" class="icon-dot-single"></i>Nombre Info<i id="cont-icon" class="icon-bookmark"></i></label>
                <input type="text" name="detalle_info" id="detalle_info" class="campo-admin" placeholder="Detalle de la info" spellcheck="false" autocomplete="off" maxlength="50" required value="{{$info->detalle_info}}">
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="text" name="pagina_web" id="pagina_web" class="campo-admin" placeholder="Dirección web" spellcheck="false" autocomplete="off" maxlength="50" value="{{$info->pagina_web}}">
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="file" class="campo-admin" name="imagen_info" id="imagen_info">
            </div>
        ...
        <button class="boton-admin" id="crear-servicio"> Editar INFO</button>
    </form>
</div>
