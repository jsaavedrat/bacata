...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-attribution"> </i> INFOS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; LISTA</div>
    <div id="content-imagen-titulo"><img style="height:100%;float: right;" id="imagen-principal"></div>
</div>

<div id="iconos-titulo">
    <div class="icono-titulo"><a href="{{ route('home') }}">         <i class="fa fa-home herramientas"></i><div class="content-texto"><p class="texto-icono">INICIO</p></div></a></div>
    <div class="icono-titulo"><a href="{{ route('pagina.infos.crear') }}"><i class="fa fa-plus herramientas"></i><div class="content-texto"><p class="texto-icono">AGREGAR INFO</p></div></a></div>
...
<div id="elemento-admin">
    <div id="texto-titulo"> <i class="icon-list"> </i> INFOS MOSTRADOS EN PÁGINA WEB</div>

    <div id="content-mensaje">
        @if($estatus=="exito")<div id="mensaje-exito" onclick="this.style.display='none'"> <i class="fa fa-check-circle"></i> Info agregada con Éxito.</div>@endif
        @if($estatus=="eliminado")<div id="mensaje-exito" onclick="this.style.display='none'"> <i class="fa fa-check-circle"></i> Info eliminada con Éxito.</div>@endif
        @if($estatus=="actualizado")<div id="mensaje-exito" onclick="this.style.display='none'"> <i class="fa fa-check-circle"></i>&nbsp; Info Actualizada con Éxito.</div>@endif
        @if($estatus=="error")<div id="mensaje-error" onclick="this.style.display='none'"> <i class="fa fa-times-circle"></i>&nbsp; No se pudo eliminar la Info.</div>@endif
    </div>
        ...
        <tbody>
            ...
            @foreach($infos as $info)
                <tr>
                    ...
                    <td id="td-imagen"><div class="content-imagen-td"><img src="{{ asset('public/imagenes/pagina/infos') }}/{{$info->imagen_info}}" style="height: 100%;"> </div></td>
                    <td>{{$info->nombre_info}}</td>
                    <td>{{$info->detalle_info}}</td>
                    <td>{{$info->pagina_web}}</td>
                    <td class="td-acciones">
                        <div class="iconos-acciones">
                            <div class="content-acciones">
                                <p class="dropdown-content"><i class="icon-forward"> </i> VER</p>
                                <a href="{{ route('welcome') }}#infos" target="_blank"><i class="icon-forward i-acciones"> </i> &nbsp;</a>
                            </div>
                            <div class="content-acciones">
                                <a class="dropdown-content"><i class="icon-pencil"> </i> EDITAR</a>
                                <i onclick="editar('{{$info->id_info}}');" class="icon-pencil i-acciones"> </i> &nbsp;
                            </div>
                            <div class="content-acciones">
                                <a class="dropdown-content"><i class="icon-trash"> </i> ELIMINAR</a>
                                <i onclick="eliminar('{{$info->id_info}}','{{$info->nombre_info}}');" class="icon-trash i-acciones"></i>
                            </div>
                        </div>
                    </td>
                </tr> 
...
<div id="modal-eliminar">
    <form method="post" action="{{ route('pagina.infos.inactivar') }}">
        @csrf
        <div id="content-modal-eliminar">
            <div id="imagen-modal-eliminar">
                ...
                <div id="mensaje-confirmacion-eliminar">¿Realmente deseas eliminar la Info: <x id="nombre-eliminar"></x></div>
...
<form method="post" action="{{ route('pagina.infos.editar') }}">
    @csrf
