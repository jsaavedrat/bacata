...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-pencil"> </i> Modificar Servicio en página Web</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.servicios.modificar') }}" enctype="multipart/form-data">
        @csrf
        <div style="width: 100%;float: left;">
            <div class="label-campo" style="width: 50%;">
                ...
                <input type="text" name="nombre_servicio" id="nombre_servicio" class="campo-admin" placeholder="Nombre del servicio" spellcheck="false" autocomplete="off" maxlength="50" required value="{{$servicio->nombre_servicio}}">
            </div>
            ...
            <div class="label-campo" style="width: 50%;">
                ...
                <input type="file" class="campo-admin" name="imagen_servicio" id="imagen_servicio">
            </div>
            ...
            <div class="label-campo" style="width: 100%;">
                ...
                <textarea name="descripcion_servicio" id="descripcion_servicio" class="campo-admin" placeholder="Descripción del servicio" spellcheck="false" autocomplete="off" maxlength="3000" style="height: 70px;">{{$servicio->descripcion_servicio}}</textarea>
            </div>
        ...
        <button class="boton-admin" id="crear-servicio"> Editar Servicio</button>
    </form>
</div>
