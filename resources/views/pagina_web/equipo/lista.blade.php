...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-attribution"> </i> SECCIÓN EQUIPO DE TRABAJO&nbsp;<i class="fa fa-angle-right"> </i>&nbsp; LISTA</div>
    <div id="content-imagen-titulo"><img style="height:100%;float: right;" id="imagen-principal"></div>
</div>

<div id="iconos-titulo">
    <div class="icono-titulo"><a href="{{ route('home') }}">         <i class="fa fa-home herramientas"></i><div class="content-texto"><p class="texto-icono">INICIO</p></div></a></div>
    <div class="icono-titulo"><a href="{{ route('pagina.equipo.crear') }}"><i class="fa fa-plus herramientas"></i><div class="content-texto"><p class="texto-icono">AGREGAR IMAGEN EQUIPO</p></div></a></div>
...
<div id="elemento-admin">
    <div id="texto-titulo"> <i class="icon-list"> </i> IMAGENES EQUIPO DE TRABAJO MOSTRADAS EN PÁGINA WEB</div>

    <div id="content-mensaje">
        @if($estatus=="exito")<div id="mensaje-exito" onclick="this.style.display='none'"> <i class="fa fa-check-circle"></i> Imagen equipo agregada con Éxito.</div>@endif
        @if($estatus=="eliminado")<div id="mensaje-exito" onclick="this.style.display='none'"> <i class="fa fa-check-circle"></i> Imagen equipo eliminada con Éxito.</div>@endif
        @if($estatus=="actualizado")<div id="mensaje-exito" onclick="this.style.display='none'"> <i class="fa fa-check-circle"></i>&nbsp; Imagen equipo Actualizada con Éxito.</div>@endif
        ...
        <tbody>
            ...
            @foreach($imagenes_equipo as $imagen_equipo)
                <tr>
                    ...
                    <td id="td-imagen"><div class="content-imagen-td"><img src="{{ asset('public/imagenes/pagina/equipo') }}/{{$imagen_equipo->nombre_imagen_equipo}}" style="height: 100%;"> </div></td>
                    <td>{{$imagen_equipo->titulo_imagen_equipo}}</td>
                    <td>{{$imagen_equipo->orden}}</td>
                    <td class="td-acciones">
                        <div class="iconos-acciones">
                            <div class="content-acciones">
                                <p class="dropdown-content"><i class="icon-forward"> </i> VER</p>
                                <a href="{{ route('welcome') }}#equipo" target="_blank"><i class="icon-forward i-acciones"> </i> &nbsp;</a>
                            </div>
                            <div class="content-acciones">
                                <a class="dropdown-content"><i class="icon-pencil"> </i> EDITAR</a>
                                <i onclick="editar('{{$imagen_equipo->id_imagen_equipo}}');" class="icon-pencil i-acciones"> </i> &nbsp;
                            </div>
                            <div class="content-acciones">
                                <a class="dropdown-content"><i class="icon-trash"> </i> ELIMINAR</a>
                                <i onclick="eliminar('{{$imagen_equipo->id_imagen_equipo}}','{{$imagen_equipo->titulo_imagen_equipo}}');" class="icon-trash i-acciones"></i>
                            </div>
                        </div>
                    </td>
                </tr> 
