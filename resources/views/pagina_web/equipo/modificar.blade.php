...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-attribution"> </i> SECCIÓN EQUIPO DE TRABAJO &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; MODIFICAR IMAGEN</div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> EDITAR IMAGEN EQUIPO DE TRABAJO</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.equipo.modificar') }}" enctype="multipart/form-data">
        @csrf
