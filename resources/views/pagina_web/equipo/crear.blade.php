...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-attribution"> </i> SECCIÓN EQUIPO DE TRABAJO&nbsp;<i class="fa fa-angle-right"> </i>&nbsp; AGREGAR IMAGEN</div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> AGREGAR IMAGEN EQUIPO DE TRABAJO</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.equipo.guardar') }}" enctype="multipart/form-data">
        @csrf
        <div style="width: 100%;float: left;">
            <div class="label-campo">
                ...
                <input type="text" name="titulo_imagen_equipo" id="titulo_imagen_equipo" class="campo-admin" placeholder="Titulo imagen" spellcheck="false" autocomplete="off" maxlength="50" required>
            </div>

            <div class="label-campo">
                <div id="error-imagen" style="display: none;" onclick="this.style.display='none'">Seleccione la imagen</div>
                <label class="label-admin" for="nombre_imagen_equipo"><i id="lista" class="icon-dot-single"></i>Seleccione imagen (Máximo 2MB)<i id="cont-icon" class="icon-image"></i></label>
                <input type="file" class="campo-admin" name="nombre_imagen_equipo" id="nombre_imagen_equipo" required accept=".jpg,.png,.jpeg">
            </div>
        ...
        <button class="boton-admin" id="crear-logo-marca"> Agregar IMAGEN EQUIPO</button>
    </form>
</div>
