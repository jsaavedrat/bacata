...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="fa fa-image"> </i> CARRUSEL &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; EDITAR</div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> MODIFICAR IMAGEN CARRUSEL</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.carrusel.modificar') }}" enctype="multipart/form-data">
        @csrf
        <div style="width: 100%;float: left;">
            ...
            <div class="label-campo">
                ...
                <input type="file" class="campo-admin" name="imagen_carrusel" id="imagen_carrusel" accept=".jpg,.jpeg,.png">
            </div>

            <div class="label-campo" id="label-texto-banner-2">
                <label class="label-admin" for="titulo_carrusel"><i id="lista" class="icon-dot-single"></i>Título Carrusel<i id="cont-icon" class="icon-image"></i></label>
                <input class="campo-admin" name="titulo_carrusel" id="titulo_carrusel" maxlength="100" placeholder="Texto grande del banner en carrusel" value="{{$imagen_carrusel->titulo_carrusel}}" autocomplete="off" spellcheck="false">
            </div>
            ...
            <div class="label-campo" id="label-texto-banner">
                ...
                <input class="campo-admin" name="subtitulo_carrusel" id="subtitulo_carrusel" maxlength="100" placeholder="Texto pequeño del banner en carrusel" value="{{$imagen_carrusel->subtitulo_carrusel}}" autocomplete="off" spellcheck="false">
            </div>
            ...
            <div class="label-campo" id="label-texto-banner-3">
                ...
                <textarea class="campo-admin" name="descripcion_carrusel" id="descripcion_carrusel" maxlength="100" placeholder="Texto descriptivo del carrusel" style="margin-bottom: -5px!important;" autocomplete="off" spellcheck="false">{{$imagen_carrusel->descripcion_carrusel}}</textarea>
            </div>
            ...
            <div class="label-campo" id="label-color-banner">
                ...
                <input type="color" class="campo-admin" name="color_texto_carrusel" id="color_texto_carrusel" value="{{$imagen_carrusel->color_texto_carrusel}}">
            </div>
            ...
            <div class="label-campo" id="label-color-banner">
                ...
                <select class="campo-admin" name="color_desvanecido_fondo" id="color_desvanecido_fondo" value="{{$imagen_carrusel->color_desvanecido_fondo}}">
            ...
            <div class="label-campo">
                ...
                <input type="number" class="campo-admin" name="orden" id="orden" placeholder="Ingresa el numero" value="{{$imagen_carrusel->orden}}">
            </div>

            <input type="hidden" name="id_imagen_carrusel" value="{{$imagen_carrusel->id_imagen_carrusel}}">
            
        </div>

        <button class="boton-admin" id="crear-promocion-pagina"> Modificar Imagen</button>
    </form>
</div>
...
<script type="text/javascript">
    ...
    document.getElementById("color_desvanecido_fondo").value = "{{$imagen_carrusel->color_desvanecido_fondo}}";
