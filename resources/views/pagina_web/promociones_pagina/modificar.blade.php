...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="fa fa-dollar"> </i> PROMOCIONES PAGINA WEB &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; EDITAR</div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> EDITAR PROMOCIÓN EN PÁGINA WEB</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.promociones_pagina.modificar') }}" enctype="multipart/form-data">
        @csrf
        <div style="width: 100%;float: left;">
            <div class="label-campo">
                ...
                <input type="text" name="nombre_promocion_pagina" id="nombre_promocion_pagina" class="campo-admin" placeholder="Nombre de la promoción" spellcheck="false" autocomplete="off" maxlength="50" required value="{{$promocion_pagina->nombre_promocion_pagina}}">
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="file" class="campo-admin" name="imagen_promocion_pagina" id="imagen_promocion_pagina" accept=".jpg,.jpeg,.png">
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="text" name="resultado_promocion" id="resultado_promocion" class="campo-admin" placeholder="Ejemplo: Ganaste una montura" spellcheck="false" autocomplete="off" maxlength="50" required value="{{$promocion_pagina->resultado_promocion}}">
            </div>
        ...
        <button class="boton-admin" id="crear-promocion-pagina"> Editar promoción</button>
    </form>
</div>
...
<script type="text/javascript">
        ...
        if(opcion_qr == "SI"){
            $("#label-qr").after(`
                ...
                <div class="label-campo" id="label-texto-qr">
                    ...
                    <input class="campo-admin" name="texto_qr" id="texto_qr" maxlength="60" placeholder="Ejemplo: Escanéa el QR y gana un premio." required value="{{$promocion_pagina->texto_qr}}">
                </div>
                <div class="label-campo" id="label-color-qr">
                    ...
                    <input type="color" class="campo-admin" name="color_texto_qr" id="color_texto_qr" required value="{{$promocion_pagina->color_texto_qr}}">
                </div>
            `);
        }else{
        ...
        if(opcion_banner == "SI"){
            $("#label-banner").after(`
                ...
                <div class="label-campo" id="label-texto-banner">
                    ...
                    <input class="campo-admin" name="texto_banner" id="texto_banner" maxlength="50" placeholder="Ejemplo: Promoción en tienda física" required value="{{$promocion_pagina->texto_banner}}">
                </div>
                <div class="label-campo" id="label-texto-banner-2">
                    ...
                    <input class="campo-admin" name="texto_banner_2" id="texto_banner_2" maxlength="50" placeholder="Ejemplo: Válido desde:_ hasta:_" required value="{{$promocion_pagina->texto_banner_2}}">
                </div>
                <div class="label-campo" id="label-color-banner">
                    ...
                    <input type="color" class="campo-admin" name="color_texto_banners" id="color_texto_banners" required value="{{$promocion_pagina->color_texto_banners}}">
                </div>
            `);
        }else{
    ...
    document.getElementById("mostrar_qr").value = "{{$promocion_pagina->mostrar_qr}}";
    seleccionoQr("{{$promocion_pagina->mostrar_qr}}");
    document.getElementById("mostrar_banner").value = "{{$promocion_pagina->mostrar_banner}}";
    seleccionoBanner("{{$promocion_pagina->mostrar_banner}}");

    if($("#ubicacion_qr").length){
        document.getElementById("ubicacion_qr").value = "{{$promocion_pagina->ubicacion_qr}}";
    }
    if($("#ubicacion_banner").length){
        document.getElementById("ubicacion_banner").value = "{{$promocion_pagina->ubicacion_banner}}";
    }
