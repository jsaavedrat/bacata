...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-attribution"> </i> SECCIÓN KIDS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; CAMBIAR FONDO</div>
...
<div id="elemento-admin">
    <div id="content-mensaje">
        @if($estatus=="exito")<div id="mensaje-exito" onclick="this.style.display='none'"> <i class="fa fa-check-circle"></i> Fondo actualizado con exito.</div>@endif
    </div>

    <div id="texto-titulo"> <i class="icon-pencil"> </i> CAMBIAR FONDO SECCIÓN KIDS</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.kids.fondo.guardar') }}" enctype="multipart/form-data">
        @csrf
        ...
        <button class="boton-admin" id="crear-logo-marca"> CAMBIAR FONDO KIDS</button>
    </form>
</div>
