...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-creative-commons-attribution"> </i> SECCIÓN KIDS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; MODIFICAR IMAGEN</div>
...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="icon-pencil"> </i> AGREGAR IMAGEN KIDS</div>

    <form method="post" data-parsley-validate action="{{ route('pagina.kids.modificar') }}" enctype="multipart/form-data">
        @csrf
        <div style="width: 100%;float: left;">
            <div class="label-campo">
                ...
                <input type="text" name="titulo_imagen_kids" id="titulo_imagen_kids" class="campo-admin" placeholder="Titulo imagen" spellcheck="false" autocomplete="off" maxlength="50" required value="{{$imagen_kids->titulo_imagen_kids}}">
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="file" class="campo-admin" name="nombre_imagen_kids" id="nombre_imagen_kids">
            </div>
            ...
            <div class="label-campo">
                ...
                <input type="number" class="campo-admin" name="orden" id="orden" placeholder="Ingresa el numero" value="{{$imagen_kids->orden}}">
            </div>
        </div>
        <input type="hidden" name="id_imagen_kids" value="{{$imagen_kids->id_imagen_kids}}">

        <button class="boton-admin" id="crear-logo-marca"> Editar Imagen KIDS</button>
    </form>
</div>
