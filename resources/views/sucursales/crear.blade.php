...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="fa fa-home"> </i> SUCURSALES &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; CREAR</div>
...
<div id="elemento-admin">
    <div id="content-mensaje">
        @if($estatus=="exito")<div id="mensaje-exito" onclick="this.style.display='none'"> <i class="fa fa-check-circle"></i> Sucursal creada con Éxito.</div>@endif
        @if($estatus=="error")<div id="mensaje-error" onclick="this.style.display='none'"> <i class="fa fa-times-circle"></i>&nbsp; Nombre de Sucursal ya existe.</div>@endif
    </div>

    <div id="texto-titulo"> <i class="fa fa-plus"> </i> Crear Sucursal</div>

    <form method="post" data-parsley-validate action="{{ route('sucursales.guardar') }}" enctype="multipart/form-data">
        @csrf
        <div class="label-campo">
            ...
            <input type="text" name="nombre_sucursal" id="nombre_sucursal" class="campo-admin" placeholder="Nombre" spellcheck="false" autocomplete="off" maxlength="25" onkeyup="this.value=letras(this.value)" required>
        </div>
        ...
        <div class="label-campo">
            ...
            <input type="text" name="correo_sucursal" id="correo_sucursal" class="campo-admin" placeholder="Correo" spellcheck="false" autocomplete="off" maxlength="100" required>
        </div>
        ...
        <div class="label-campo">
            ...
            <input type="text" name="telefono_sucursal" id="telefono_sucursal" class="campo-admin" placeholder="Teléfono" spellcheck="false" autocomplete="off" maxlength="25" onkeyup="this.value=telefono(this.value)" required>
        </div>

        <input type="hidden" name="estado_sucursal" value="activo">
        ...
        <div class="label-campo">
            ...
            <input type="file" class="campo-admin" name="imagen_sucursal" id="imagen_sucursal" required>
        </div>
        ...
        <div class="label-campo">
            ...
            <textarea name="direccion_sucursal" id="direccion_sucursal" class="campo-admin" placeholder="Dirección" spellcheck="false" autocomplete="off" maxlength="120" required onkeyup="this.value=direccion(this.value)"></textarea>
        </div>
        ...
        <div class="label-campo">
            ...
            <textarea name="mapa_sucursal" id="mapa_sucursal" class="campo-admin" placeholder="Pegue aquí el codigo del mapa" spellcheck="false" autocomplete="off" maxlength="2000" required></textarea>
        </div>

        <button class="boton-admin" id="crear-sucursal"> Crear Sucursal</button>
    </form>
</div>
