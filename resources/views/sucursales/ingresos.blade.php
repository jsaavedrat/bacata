...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-icon-arrow-with-circle-down"> </i> Ingresos de {{$sucursal->nombre_sucursal}}</div>
        ...
        <tbody>
            ...
            @foreach($ingresos as $ingreso)
                <tr>
                    ...
                    <td>@isset($ingreso->nombre_bodega) {{$ingreso->nombre_bodega}} @endisset            @isset($ingreso->nombre_sucursal) {{$ingreso->nombre_sucursal}} @endisset</td>
                    <td>{{$ingreso->cantidad_salida}}</td>
                    <td>{{$ingreso->cantidad_ingresados}}</td>
                    <td>{{$ingreso->fecha_llegada_traslado}}</td>
                    <td class="estado-{{$ingreso->estado_traslado}}">{{$ingreso->estado_traslado}}</td>
                    <td class="td-acciones">
                        <div class="iconos-acciones">
                            <div class="content-acciones">
                                <a class="dropdown-content"><i class="icon-forward"> </i> VER</a>
                                <i onclick="ver('{{$ingreso->id_traslado}}');" class="icon-forward i-acciones"> </i> &nbsp;
                            </div>
                        </div>
                    </td>
                </tr> 
...
<form method="post" action="{{ route('sucursales.ver.ingreso') }}">
    @csrf
