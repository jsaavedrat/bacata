...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-shop"> </i> TIENDA VIRTUAL&nbsp;<i class="fa fa-angle-right"> </i>&nbsp; CARGAR EXCEL CON PRODUCTOS</div>
