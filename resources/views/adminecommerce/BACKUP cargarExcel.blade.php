...
<div id="titulo-admin">
    ...
    <div id="migajas-titulo"><i class="icon-arrow-with-circle-down"> </i> INGRESOS &nbsp;<i class="fa fa-angle-right"> </i>&nbsp; EXCEL</div>
...
<div id="elemento-admin">
    ...
    <form method="post" id="formulario" data-parsley-validate  action="{{ route('ingresos.sucursal.excel.guardar') }}" enctype="multipart/form-data">
        ...
        <div class="label-campo">
            ...
            <div class="label-admin"><i id="lista" class="icon-dot-single"></i>Sucursal de Ingreso:<i id="cont-icon" class="fa fa-home"></i></div>
            <select class="campo-admin" name="id_sucursal" id="id_sucursal" required>
                <option value="">Seleccione Sucursal Salida</option>
