...
<div id="elemento-admin">
    <div id="texto-titulo"> <i class="icon-list"> </i> Citas para hoy {{date("d-m-Y", strtotime($hoy))}}</div>
        ...
        <tbody>
            ...
            @foreach($citas as $cita)
                <tr>
                    ...
                    <td>{{$cita->nombres_paciente}} {{$cita->apellidos_paciente}}</td>
...
<form method="post" action="{{ route('diagnosticos.editar') }}">
    @csrf
    <input type="number" name="editar" id="editar" style="display: none;">
    <button id="boton-editar"></button>
</form>
<div id="modal-eliminar">
    <form method="post" action="{{ route('diagnosticos.inactivar') }}">
        @csrf
