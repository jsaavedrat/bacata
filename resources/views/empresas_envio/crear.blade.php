...
<div id="elemento-admin">
    ...
    <div id="texto-titulo"> <i class="fa fa-plus"> </i> Crear Empresa de Envío</div>
     
        <form method="post" data-parsley-validate action="{{ route('empresas.envio.guardar') }}" enctype="multipart/form-data">
            @csrf
            <div class="label-campo">
                ...
                <input type="text" name="nombre_empresa_envio" id="nombre_empresa" class="campo-admin" placeholder="Nombre Empresa" spellcheck="false" autocomplete="off" maxlength="35" required onkeyup="this.value=letras(this.value)">
            </div>
            <div class="label-campo">
                ...
                <input type="text" name="nombre_codigo" id="nombre_codigo" class="campo-admin" placeholder="Nombre identificador de envíos" spellcheck="false" autocomplete="off" maxlength="100" required onkeyup="this.value=letras(this.value)">
            </div>
            <div class="label-campo">
